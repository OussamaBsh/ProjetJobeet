...
class LoadJobData extends AbstractFixture implements OrderFixtureInterface
{
  public function load(ObjectManager $em)
  {
      ...
      $job_sensio_labs->setPosition('Web Dev');
      ...
      $job_sensio_labs->setHowToApply('Send your resume to Oussamma [at] ssh.com ');
